    ...
    <>
      <section className="bg-slate-900 select-none  ">
        ...
        <div className=" grid grid-cols-1 text-center p-5">
          ...
          <div>
            <h1 className="font-bold text-6xl sm:text-7xl md:text-8xl lg:text-9xl my-10 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 animate-bounce animate__delay-2s	2s">
              HeLLo Folks
            </h1>
          </div>
          <div>
        ...
        <div className="container flex mx-auto bg-slate-900 -mt-64 ">
          <div className="w-full  md:flex flex-col sm:flex-row justify-around text-xs animate__animated animate__fadeInTopLeft ">
            {/* <Slider {...settings}> */}
            {courseList.map((list) => {
              return (
                <Card
